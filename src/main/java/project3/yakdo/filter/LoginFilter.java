...
public class LoginFilter implements Filter{
	...
	private static final String[] whiteList = {"/", "/login", "/logout", "/signUp", "/signUp/emailConfirm", "/drugs", "/drugs/*", "/help/newPassword", "/help/checkSecurityCode", "/help/confirmEmail", "/css/*", "/font/*", "/cursor/*" , "/error/*"};
